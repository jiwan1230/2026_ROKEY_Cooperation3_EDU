...
**결과 이미지**: `local_test_data/sketch_placement_result.png`
...
**결과 이미지**: `local_test_data/sketch_placement_result.png` (같은 파일 갱신)
...
**결과 이미지**: `local_test_data/sketch_placement_result.png` (재갱신 — 3개 박스가
전부 벽 A에 한 줄로 정렬, 손그림 속 "이상적인 배치"와 거의 일치)
